...
## > ```
import os
input_file = open("c:\\learnpython\\data.txt","r")
...
# ReOpen the file
input_file1 = open("c:\\learnpython\\data.txt","r")
...
## > ```
import os
readlines_file = open("c:\\learnpython\\data.txt","r")
...
try:
    os.mkdir("c:\\learnpython")
except:
    pass

# STEP 2: Create a file in Write Mode 
new_file = open("c:\\learnpython\\data.txt", "w")

# STEP 3: Write to file using write method
new_file.write("Welcome to learnpython.com\n")
...
append_file = open("c:\\learnpython\\newdata.txt","a")
...
# rename c:\learnpython\data.txt to c:\learnpython\info.txt
os.rename("c:\\learnpython\\data.txt", "c:\\learnpython\\info.txt" )
## > ```
## >
