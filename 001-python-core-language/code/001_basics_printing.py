...
print('Welcome to learnpython.com python turorials');
#OUTPUT: Welcome to learnpython.com python turorials

# Print statement with append using the "," This appends a SPACE
print('Welcome to learnpython.com ' , 'python turorials "Appended"');
#OUTPUT: Welcome to learnpython.com python turorials "Appended"
...
# Create variables
strVal = 'learnpython.com'
intval = 100
print("String= %s Integer= %i" % (strVal, intval))
#OUTPUT String= learnpython.com Integer= 100
## >```
...
## >```
print('Welcome to {} training of {} language'.format('learnpython.com', 'python'));
#OUTPUT:  Welcome to learnpython.com training of python language

print('{0} and {1}'.format('learnpython.com', 'python'))
#OUTPUT:  learnpython.com and python

print('{1} and {0}'.format('learnpython.com', 'python'))
#OUTPUT: python and learnpython.com

print('{siteName} teaches {LanguageName}.'.format(siteName='learnpython.com', LanguageName='python'))
#OUTPUT: learnpython.com teaches python.

#Positional and key-value arguments can be arbitrarily combined:
print('The site {0} teaches {LanguageName}'.format('learnpython.com', LanguageName='Python'))
#OUTPUT: The site learnpython.com teaches Python
## >```
...
var_string   = "learnpython.com"  # A string type variable

print(var_integer, var_float, var_string)
#OUTPUT: 1 10.44 learnpython.com
## >```
