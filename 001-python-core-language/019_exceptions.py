...
try:
    ...
    print("Learnpython: Cannot Divide by ZERO")
## >```
...
try:
    ...
    print("Learnpython: Execution completed successfully")
## >```
...
try:
    ...
    print("Learnpython: THIS MESSAGE MUST BE PRINTED")
## >```
...
class learnpython_exception(Exception):pass

# Block to test the user defined exception
try:
    raise learnpython_exception
except learnpython_exception:
