...
# Serialize an Object
with open('c:\\Personal\\learnpython\\object.pickle', 'wb') as f:
	pickle.dump(Obj1, f)
    
# DeSerialize File to Object
with open('c:\\Personal\\learnpython\\object.pickle', 'rb') as f:
...
# Serialize an Dict
with open('c:\\Personal\\learnpython\\dict.pickle', 'wb') as f:
	pickle.dump(Dict1, f)

# DeSerialize File to Object
with open('c:\\Personal\\learnpython\\dict.pickle', 'rb') as f:
